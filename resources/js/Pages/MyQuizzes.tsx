            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg p-6">
                        <h1 className="text-3xl font-bold text-red-600 mb-8">My Quizzes</h1>
                                            ...
                                            <div key={quiz.id} className="bg-gray-100 rounded-lg p-4 flex items-start gap-4 shadow-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                                                        ...
                                                        <Link href={route('quizzes.edit', quiz.id)} className="text-green-600 hover:underline text-sm flex items-center">
                                        ...
                                        {!loadingJoinedQuizzes && !errorJoinedQuizzes && joinedQuizzes.map(quiz => (
                                            <div key={quiz.id} className="bg-gray-100 rounded-lg p-4 flex items-start gap-4 shadow-sm">
                                                ...
                                                <div>
                                                    ...
                                                    {/* Quiz Code for joined quizzes might not be needed unless they re-join? */}
                                                    <p className="text-sm text-gray-700 mt-1 flex items-center gap-2">
                                                        <FileText size={16} /> {quiz.questions.length} Questions
                                                    </p>
                                                    <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                                                    ...
                                                    <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                                                        ...
                                                        <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                                                        <Clock size={16} /> Status: {(quiz.statusquiz)}
                                                    </p>
                                                    <div className="mt-2">
                                                       <div className="mt-2 flex gap-2">
                                                        <Link
